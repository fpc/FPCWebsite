...
./aboutus.html.fi: aboutus.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//aboutus.html.fi -oe iso-8859-1 aboutus.adp
...
./aboutus.html.zh-CN: aboutus.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//aboutus.html.zh-CN -oe UTF-8 aboutus.adp
...
./aboutus.var: gen_makefile.conf
	...
	echo >> aboutus.var
	echo 'URI: aboutus.html.fi' >> aboutus.var
	echo 'Content-language: fi' >> aboutus.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//aboutus.var
	echo >> aboutus.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//aboutus.var
	echo >> aboutus.var
	echo 'URI: aboutus.html.zh-CN' >> aboutus.var
	echo 'Content-language: zh-CN' >> aboutus.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//aboutus.var
	echo >> aboutus.var
...
./advantage.html.zh-CN: advantage.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//advantage.html.zh-CN -oe UTF-8 advantage.adp
...
./advantage.var: gen_makefile.conf
	...
	echo 'Content-type: text/html; charset=UTF-8' >> .//advantage.var
	echo >> advantage.var
...
./credits.html.fi: credits.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//credits.html.fi -oe iso-8859-1 credits.adp
...
./credits.html.zh-CN: credits.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//credits.html.zh-CN -oe UTF-8 credits.adp
...
./credits.var: gen_makefile.conf
	...
	echo >> credits.var
	echo 'URI: credits.html.fi' >> credits.var
	echo 'Content-language: fi' >> credits.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//credits.var
	echo >> credits.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//credits.var
	echo >> credits.var
	echo 'URI: credits.html.zh-CN' >> credits.var
	echo 'Content-language: zh-CN' >> credits.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//credits.var
	echo >> credits.var
...
./develop.html.fi: develop.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//develop.html.fi -oe iso-8859-1 develop.adp
...
./develop.html.zh-CN: develop.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//develop.html.zh-CN -oe UTF-8 develop.adp
...
./develop.var: gen_makefile.conf
	...
	echo >> develop.var
	echo 'URI: develop.html.fi' >> develop.var
	echo 'Content-language: fi' >> develop.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//develop.var
	echo >> develop.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//develop.var
	echo >> develop.var
	echo 'URI: develop.html.zh-CN' >> develop.var
	echo 'Content-language: zh-CN' >> develop.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//develop.var
	echo >> develop.var
...
./download.html.fi: download.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//download.html.fi -oe iso-8859-1 download.adp
...
./download.html.zh-CN: download.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//download.html.zh-CN -oe UTF-8 download.adp
...
./download.var: gen_makefile.conf
	...
	echo >> download.var
	echo 'URI: download.html.fi' >> download.var
	echo 'Content-language: fi' >> download.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//download.var
	echo >> download.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//download.var
	echo >> download.var
	echo 'URI: download.html.zh-CN' >> download.var
	echo 'Content-language: zh-CN' >> download.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//download.var
	echo >> download.var
...
./docs.html.fi: docs.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//docs.html.fi -oe iso-8859-1 docs.adp
...
./docs.html.zh-CN: docs.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//docs.html.zh-CN -oe UTF-8 docs.adp
...
./docs.var: gen_makefile.conf
	...
	echo >> docs.var
	echo 'URI: docs.html.fi' >> docs.var
	echo 'Content-language: fi' >> docs.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//docs.var
	echo >> docs.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//docs.var
	echo >> docs.var
	echo 'URI: docs.html.zh-CN' >> docs.var
	echo 'Content-language: zh-CN' >> docs.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//docs.var
	echo >> docs.var
...
./faq.html.fi: faq.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//faq.html.fi -oe iso-8859-1 faq.adp
...
./faq.html.zh-CN: faq.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//faq.html.zh-CN -oe UTF-8 faq.adp
...
./faq.var: gen_makefile.conf
	...
	echo >> faq.var
	echo 'URI: faq.html.fi' >> faq.var
	echo 'Content-language: fi' >> faq.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//faq.var
	echo >> faq.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//faq.var
	echo >> faq.var
	echo 'URI: faq.html.zh-CN' >> faq.var
	echo 'Content-language: zh-CN' >> faq.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//faq.var
	echo >> faq.var
...
./fpc.html.fi: fpc.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//fpc.html.fi -oe iso-8859-1 fpc.adp
...
./fpc.html.zh-CN: fpc.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//fpc.html.zh-CN -oe UTF-8 fpc.adp
...
./fpc.var: gen_makefile.conf
	...
	echo >> fpc.var
	echo 'URI: fpc.html.fi' >> fpc.var
	echo 'Content-language: fi' >> fpc.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//fpc.var
	echo >> fpc.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//fpc.var
	echo >> fpc.var
	echo 'URI: fpc.html.zh-CN' >> fpc.var
	echo 'Content-language: zh-CN' >> fpc.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//fpc.var
	echo >> fpc.var
...
./fpcmac.html.fi: fpcmac.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//fpcmac.html.fi -oe iso-8859-1 fpcmac.adp
...
./fpcmac.html.zh-CN: fpcmac.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//fpcmac.html.zh-CN -oe UTF-8 fpcmac.adp
...
./fpcmac.var: gen_makefile.conf
	...
	echo >> fpcmac.var
	echo 'URI: fpcmac.html.fi' >> fpcmac.var
	echo 'Content-language: fi' >> fpcmac.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//fpcmac.var
	echo >> fpcmac.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//fpcmac.var
	echo >> fpcmac.var
	echo 'URI: fpcmac.html.zh-CN' >> fpcmac.var
	echo 'Content-language: zh-CN' >> fpcmac.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//fpcmac.var
	echo >> fpcmac.var
...
./future.html.fi: future.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//future.html.fi -oe iso-8859-1 future.adp
...
./future.html.zh-CN: future.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//future.html.zh-CN -oe UTF-8 future.adp
...
./future.var: gen_makefile.conf
	...
	echo >> future.var
	echo 'URI: future.html.fi' >> future.var
	echo 'Content-language: fi' >> future.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//future.var
	echo >> future.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//future.var
	echo >> future.var
	echo 'URI: future.html.zh-CN' >> future.var
	echo 'Content-language: zh-CN' >> future.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//future.var
	echo >> future.var
...
./lang_howto.html.fi: lang_howto.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//lang_howto.html.fi -oe iso-8859-1 lang_howto.adp
...
./lang_howto.html.zh-CN: lang_howto.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//lang_howto.html.zh-CN -oe UTF-8 lang_howto.adp
...
./lang_howto.var: gen_makefile.conf
	...
	echo >> lang_howto.var
	echo 'URI: lang_howto.html.fi' >> lang_howto.var
	echo 'Content-language: fi' >> lang_howto.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//lang_howto.var
	echo >> lang_howto.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//lang_howto.var
	echo >> lang_howto.var
	echo 'URI: lang_howto.html.zh-CN' >> lang_howto.var
	echo 'Content-language: zh-CN' >> lang_howto.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//lang_howto.var
	echo >> lang_howto.var
...
./links.html.fi: links.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//links.html.fi -oe iso-8859-1 links.adp
...
./links.html.zh-CN: links.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//links.html.zh-CN -oe UTF-8 links.adp
...
./links.var: gen_makefile.conf
	...
	echo >> links.var
	echo 'URI: links.html.fi' >> links.var
	echo 'Content-language: fi' >> links.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//links.var
	echo >> links.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//links.var
	echo >> links.var
	echo 'URI: links.html.zh-CN' >> links.var
	echo 'Content-language: zh-CN' >> links.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//links.var
	echo >> links.var
...
./maillist.html.fi: maillist.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//maillist.html.fi -oe iso-8859-1 maillist.adp
...
./maillist.html.zh-CN: maillist.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//maillist.html.zh-CN -oe UTF-8 maillist.adp
...
./maillist.var: gen_makefile.conf
	...
	echo >> maillist.var
	echo 'URI: maillist.html.fi' >> maillist.var
	echo 'Content-language: fi' >> maillist.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//maillist.var
	echo >> maillist.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//maillist.var
	echo >> maillist.var
	echo 'URI: maillist.html.zh-CN' >> maillist.var
	echo 'Content-language: zh-CN' >> maillist.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//maillist.var
	echo >> maillist.var
...
./mirrors.html.fi: mirrors.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//mirrors.html.fi -oe iso-8859-1 mirrors.adp
...
./mirrors.html.zh-CN: mirrors.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//mirrors.html.zh-CN -oe UTF-8 mirrors.adp
...
./mirrors.var: gen_makefile.conf
	...
	echo >> mirrors.var
	echo 'URI: mirrors.html.fi' >> mirrors.var
	echo 'Content-language: fi' >> mirrors.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//mirrors.var
	echo >> mirrors.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//mirrors.var
	echo >> mirrors.var
	echo 'URI: mirrors.html.zh-CN' >> mirrors.var
	echo 'Content-language: zh-CN' >> mirrors.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//mirrors.var
	echo >> mirrors.var
...
./moreinfo.html.fi: moreinfo.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//moreinfo.html.fi -oe iso-8859-1 moreinfo.adp
...
./moreinfo.html.zh-CN: moreinfo.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//moreinfo.html.zh-CN -oe UTF-8 moreinfo.adp
...
./moreinfo.var: gen_makefile.conf
	...
	echo >> moreinfo.var
	echo 'URI: moreinfo.html.fi' >> moreinfo.var
	echo 'Content-language: fi' >> moreinfo.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//moreinfo.var
	echo >> moreinfo.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//moreinfo.var
	echo >> moreinfo.var
	echo 'URI: moreinfo.html.zh-CN' >> moreinfo.var
	echo 'Content-language: zh-CN' >> moreinfo.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//moreinfo.var
	echo >> moreinfo.var
...
./news.html.fi: news.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//news.html.fi -oe iso-8859-1 news.adp
...
./news.html.zh-CN: news.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//news.html.zh-CN -oe UTF-8 news.adp
...
./news.var: gen_makefile.conf
	...
	echo >> news.var
	echo 'URI: news.html.fi' >> news.var
	echo 'Content-language: fi' >> news.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//news.var
	echo >> news.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//news.var
	echo >> news.var
	echo 'URI: news.html.zh-CN' >> news.var
	echo 'Content-language: zh-CN' >> news.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//news.var
	echo >> news.var
...
./port.html.fi: port.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//port.html.fi -oe iso-8859-1 port.adp
...
./port.html.zh-CN: port.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//port.html.zh-CN -oe UTF-8 port.adp
...
./port.var: gen_makefile.conf
	...
	echo >> port.var
	echo 'URI: port.html.fi' >> port.var
	echo 'Content-language: fi' >> port.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//port.var
	echo >> port.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//port.var
	echo >> port.var
	echo 'URI: port.html.zh-CN' >> port.var
	echo 'Content-language: zh-CN' >> port.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//port.var
	echo >> port.var
...
./prog.html.fi: prog.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//prog.html.fi -oe iso-8859-1 prog.adp
...
./prog.html.zh-CN: prog.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//prog.html.zh-CN -oe UTF-8 prog.adp
...
./prog.var: gen_makefile.conf
	...
	echo >> prog.var
	echo 'URI: prog.html.fi' >> prog.var
	echo 'Content-language: fi' >> prog.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//prog.var
	echo >> prog.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//prog.var
	echo >> prog.var
	echo 'URI: prog.html.zh-CN' >> prog.var
	echo 'Content-language: zh-CN' >> prog.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//prog.var
	echo >> prog.var
...
./probs.html.fi: probs.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//probs.html.fi -oe iso-8859-1 probs.adp
...
./probs.html.zh-CN: probs.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//probs.html.zh-CN -oe UTF-8 probs.adp
...
./probs.var: gen_makefile.conf
	...
	echo >> probs.var
	echo 'URI: probs.html.fi' >> probs.var
	echo 'Content-language: fi' >> probs.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//probs.var
	echo >> probs.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//probs.var
	echo >> probs.var
	echo 'URI: probs.html.zh-CN' >> probs.var
	echo 'Content-language: zh-CN' >> probs.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//probs.var
	echo >> probs.var
...
./units.html.fi: units.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//units.html.fi -oe iso-8859-1 units.adp
...
./units.html.zh-CN: units.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//units.html.zh-CN -oe UTF-8 units.adp
...
./units.var: gen_makefile.conf
	...
	echo >> units.var
	echo 'URI: units.html.fi' >> units.var
	echo 'Content-language: fi' >> units.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//units.var
	echo >> units.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//units.var
	echo >> units.var
	echo 'URI: units.html.zh-CN' >> units.var
	echo 'Content-language: zh-CN' >> units.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//units.var
	echo >> units.var
...
./unitsrtl.html.fi: unitsrtl.adp default-master.adp site-master.adp ./catalog.fi.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.fi.adp -l fi_FI -m default-master.adp -o .//unitsrtl.html.fi -oe iso-8859-1 unitsrtl.adp
...
./unitsrtl.html.zh-CN: unitsrtl.adp default-master.adp site-master.adp ./catalog.zh-CN.adp
	./adp2html -p x=$(URL_EXTENSION) -c ./catalog.zh-CN.adp -l zh_CN -m default-master.adp -o .//unitsrtl.html.zh-CN -oe UTF-8 unitsrtl.adp
...
./unitsrtl.var: gen_makefile.conf
	...
	echo >> unitsrtl.var
	echo 'URI: unitsrtl.html.fi' >> unitsrtl.var
	echo 'Content-language: fi' >> unitsrtl.var
	echo 'Content-type: text/html; charset=iso-8859-1' >> .//unitsrtl.var
	echo >> unitsrtl.var
	...
	echo 'Content-type: text/html; charset=iso-8859-5' >> .//unitsrtl.var
	echo >> unitsrtl.var
	echo 'URI: unitsrtl.html.zh-CN' >> unitsrtl.var
	echo 'Content-language: zh-CN' >> unitsrtl.var
	echo 'Content-type: text/html; charset=UTF-8' >> .//unitsrtl.var
	echo >> unitsrtl.var

mirrors.dat:
	$(shell echo 'name\tnamel\turl' > mirrors.dat)
	$(shell echo 'Hungary\thungary\tftp://ftp.hu.freepascal.org/pub/fpc/' >> mirrors.dat)
	$(shell echo 'Netherlands\tnetherlands\tftp://freepascal.stack.nl/pub/mirrors/fpc/' >> mirrors.dat)
