...
<TRN locale="he_IL" key="website.Bugtracker">
מעקב אחר שגיאות
</TRN>
<TRN locale="he_IL" key="website.Documentation">
תיעוד
</TRN>
<TRN locale="he_IL" key="website.Community">
קהילה
</TRN>
<TRN locale="he_IL" key="website.Wiki">
Wiki
</TRN>
...
<TRN locale="he_IL" key="website.Home">
בית
</TRN>
<TRN locale="he_IL" key="website.News">
חדשות
</TRN>
<TRN locale="he_IL" key="website.Download">
הורדות
</TRN>
<TRN locale="he_IL" key="website.General">
כללי
</TRN>
...
<TRN locale="he_IL" key="website.Coding">
תיכנות
</TRN>
<TRN locale="he_IL" key="website.FPC_on_the_Mac">
FPC על Mac
</TRN>
<TRN locale="he_IL" key="website.FAQ">
שאלות שכיחות
</TRN>
<TRN locale="he_IL" key="website.Units">
יחידות
</TRN>
<TRN locale="he_IL" key="website.Contributed_Units">
יחידות שנתרמו
</TRN>
<TRN locale="he_IL" key="website.Advantages">
יתרונות
</TRN>
<TRN locale="he_IL" key="website.Development">
פיתוח
</TRN>
<TRN locale="he_IL" key="website.Future_Plans">
תוכניות עתידיות
</TRN>
<TRN locale="he_IL" key="website.Mailinglists">
רשימות תפוצה
</TRN>
<TRN locale="he_IL" key="website.Porting_from_TP7">
המרה מTP7
</TRN>
<TRN locale="he_IL" key="website.Authors">
יוצרים
</TRN>
<TRN locale="he_IL" key="website.Credits">
זכויות
</TRN>
<TRN locale="he_IL" key="website.Links_mirrors">
קישורים/מראות
</TRN>
<TRN locale="he_IL" key="website.Tools">
כלים
</TRN>
<TRN locale="he_IL" key="website.Contribute">
תרום יחידות
</TRN>
<TRN locale="he_IL" key="website.More_information">
מידע נוסף
</TRN>
<TRN locale="fr_FR" key="website.overview">
Vue d'ensemble
</TRN>
<TRN locale="fr_FR" key="website.License">
Licence
</TRN>
<TRN locale="fr_FR" key="website.Requirements">
Matériel nécessaire
</TRN>
...
<TRN locale="bg_BG" key="website.Advantages">
Предимства
</TRN>
<TRN locale="bg_BG" key="website.Mailinglists">
Пощенски списъци
</TRN>
<TRN locale="bg_BG" key="website.Authors">
Автори
</TRN>
<TRN locale="bg_BG" key="website.searchwhat">
Търсене в документите, форумите и пощенските списъци.
</TRN>
<TRN locale="bg_BG" key="website.Links_mirrors">
Връзки/Огледала
</TRN>
<TRN locale="bg_BG" key="website.Tools">
Инструменти
</TRN>
<TRN locale="bg_BG" key="website.search">
Търсене
</TRN>
<TRN locale="bg_BG" key="website.Feeling_Lucky">
Чувствам се късметлия
</TRN>
<TRN locale="bg_BG" key="website.Contribute">
Допринасяне
</TRN>
<TRN locale="bg_BG" key="website.FAQ">
ЧЗВ
</TRN>
<TRN locale="bg_BG" key="website.Wiki">
Уики
</TRN>
...
<TRN locale="bg_BG" key="website.News">
Новини
</TRN>
<TRN locale="bg_BG" key="website.Download">
Изтегляне
</TRN>
<TRN locale="bg_BG" key="website.Community">
Общество
</TRN>
<TRN locale="bg_BG" key="website.Documentation">
Документи
</TRN>
<TRN locale="bg_BG" key="website.Development">
Разработка
</TRN>
<TRN locale="bg_BG" key="website.Future_Plans">
Бъдещи планове
</TRN>
<TRN locale="bg_BG" key="website.More_information">
...
<TRN locale="nl_NL" key="website.Advantages_of">
De voordelen van programmeren in Pascal en Free Pascal
</TRN>
...
<TRN locale="fr_FR" key="website.adv_IDE">
<STRONG>Environnement de développement intégré</STRONG> Free Pascal possède un
...
<TRN locale="fr_FR" key="website.adv_multiplatform">
<STRONG>Disponible sur plusieurs architectures et de nombreuses plateformes</STRONG>
...
<TRN locale="fr_FR" key="website.adv_namespace">
<STRONG>Chaque unité possède ses propres identifiants</STRONG>
...
<TRN locale="fr_FR" key="website.adv_very_clean_lang">
<STRONG>Un language propre</STRONG> Pascal est un langage très propre.
...
<TRN locale="fr_FR" key="website.adv_No_Makefiles">
<STRONG>Pas de Makefiles</STRONG> La plupart des languages ont besoin de Makefile, pas le Pascal.
...
<TRN locale="fr_FR" key="website.adv_OOP">
...
<TRN locale="fr_FR" key="website.Advantages_of">
Les avantages de la programmation en Pascal et Free Pascal
</TRN>
<TRN locale="fr_FR" key="website.adv_assembler_integration">
<STRONG>Intégration très fine avec l'assembleur</STRONG> 
...
<TRN locale="fr_FR" key="website.adv_compatible">
<STRONG>Compatible</STRONG> Vous avez du code existant ? FreePascal est le plus compatbile de tous les compilateurs Pascal.
...
<TRN locale="fr_FR" key="website.adv_distribution_indep">
<STRONG>Indépendance des distibutions Linux</STRONG> Grace aux liens statiques, une version Linux d'un programme FreePascal marchera sur toutes les distributions (sisi, vous avez bien lu).
...
<TRN locale="bg_BG" key="website.adv_OOP">
<STRONG>Обектно ориентирано програмиране</STRONG> И ако се занимавате със сериозно програмиране, разбира се се интересувате от обектно ориентирано програмиране. Използвайте Турбо Паскал и Обектен Паскал видовете ООП според вашия вкус. СБК и Свободен Vision ви предоставят мощни обектни библиотеки от които се нуждаете. За нуждите от БД ние поддържаме PostgreSQL, MySQL, Interbase и ODBC.
</TRN>
<TRN locale="bg_BG" key="website.adv_Smartlink">
<STRONG>Интелигентно линкване</STRONG> Умния линкер на Свободен Паскал изхвърля всяка променлива или код, който не използвате. Това прави Малки програми с главно М, и в същото време те са статично свързани избягвайки ада на динамичните библиотеки!
</TRN>
<TRN locale="bg_BG" key="website.adv_very_clean_lang">
<STRONG>Изключително изчистен език</STRONG> Паскал е много добър език, вашите програми ще са по-четливи и по-лесни за поддръжка отколкото например на Си, и да не забравяме за Си++. И не се налага да се отказвате от мощност - езика Паскал е толкова мощен колкото искате.
</TRN>
<TRN locale="bg_BG" key="website.already_included_installer">
вече е включен в инсталатора показан отгоре
</TRN>
<TRN locale="bg_BG" key="website.Advantages_of">
Предимства при програмира на Паскал със Свободен Паскал
</TRN>
<TRN locale="bg_BG" key="website.Advantages_title">
Предимства на Свободен Паскал
</TRN>
<TRN locale="bg_BG" key="website.adv_assembler_integration">
<STRONG>Изключителна интеграция с асемблер</STRONG> Да не мислите, че Паскал е само за новаци които трябва да учат програмиране? ГРЕШКА! Той е невероятен за хай-тек програмиране, а за закоравелите кодери имаме интегрирани асемблери. Можете лесно да смесвате асемблер с паскал, на езика който искате. Предпочитате асемблер стил Intel? Няма проблеми, ако е необходимо Свободен Паскал ще го конвертира до АТТ. Искате ли да конвертирате програмата си до сорс-код за Nasm? Няма проблеми, и всичкия АТТ асемблер в сорс-кода се конвертира автоматично.
</TRN>
<TRN locale="bg_BG" key="website.adv_compatible">
<STRONG>Съвместим</STRONG> Имате съществуващ код? Свободен Паскал е по-съвместим с него от всеки друг паскал компилатор. Той е почти напълно съвместим с Турбо Паскал и доста добре съвместим с Делфи сорс-код. Ако имате код на друг език, като C или асемблер, само използвайте любимия си компилатор за него и го извиквайте от Свободен Паскал.
</TRN>
<TRN locale="bg_BG" key="website.adv_distribution_indep">
<STRONG>Независимост от дистрибуция (Линукс)</STRONG> Като резулстат от това, софтуер компилиран от Линукс версията на Свободен Паскал работят на всяка Линукс дистрибуция, като по този начин е много, много по-лесно вашия софтуер да поддържа различни Линукс дистрибуции.
</TRN>
<TRN locale="bg_BG" key="website.adv_Fast">
<STRONG>Паскал компилаторите са Бързи с главна Б и Свободен Паскал не е изключение.</STRONG> Да, вече няма нужда да пускате корени докато си компилирате програмите, само натискате клавиша компилирай и то е готово, даже и за големи програми.
</TRN>
...
<TRN locale="bg_BG" key="website.adv_IDE">
<STRONG>Интегрирана среда за разработка(ИСР)</STRONG> Свободен Паскал идва с ИСР която работи на различни платформи, в която можете да пишете, компилирата, отсранявате грешките от програмите. Ще спестите много време като използвате ИСР - най-добрия приятел който имате.
</TRN>
<TRN locale="bg_BG" key="website.adv_multiplatform">
<STRONG>Наличен за много платформи на различни архитектури</STRONG> Свободен Паскал е наличен на повече платформи от повечето други Паскал компилатори и позволява лесна кръстосана компилация - само сменете целта в ИСР и компилирайте!. И в момента се работи по поддръжката на още повече процесори и платформи.
</TRN>
<TRN locale="bg_BG" key="website.download_old_releases">
Връзки към някои стари издания (не се поддържат вече) на FPC за платформи за които по-добра алтернатива не може да се намери <a href="down/old/down@x@">тук</a>. Не се занимавайте да изпраще отчети за грешки с тези стари издания - ние няма да ги поправим. Основният проблем защо тези платформи не се поддържат вече е липсата да поддръжници - ако се интересувате да ги съживите, свържете се с нас (например като използвате пощенски списък fpc-devel).
</TRN>
<TRN locale="bg_BG" key="website.download_snapshots">
Като допълнение към официалните издание, предлагаме и така наречените "снимки" на компилатора, RTL, ИСР и няколко други пакета на <a href="develop@x@">страницата за разработка</a>. 
Това са компилирани версии на текущите сорс-кодове с всички поправки и подобрения от последното официално издание, така че опитайте ги ако имате някакъв проблем. Разбира се, те също може да съдържат грешки.
</TRN>
<TRN locale="bg_BG" key="website.download_source">
Сорс-кода може да се изтегли отделно в <b>zip</b> файл или в <b>tar.gz</b> от някой от <a href="down/source/sources@x@">порталите за изтегляне</a>.
</TRN>
<TRN locale="bg_BG" key="website.down_sparc_linux_note">
само 2.0.0
</TRN>
<TRN locale="bg_BG" key="website.everything_in_1">
Всичко в един голям пакет
</TRN>
<TRN locale="bg_BG" key="website.Introduction">
Въведение
</TRN>
<TRN locale="bg_BG" key="website.It_is_available_in">
Наличен е в различни формати:
</TRN>
...
<TRN locale="bg_BG" key="website.news_headline_20060920">
<em>20 септември 2006</em> Като допълнение към първоначално публикуваните пакети за издание 2.0.4, powerpc-macos и x86_64-linux .deb пакети са налични (благодарности на Olle Raab и Stefan Kisdaroczi). Както обикновенно, отидете на <a href="download.html">страницата за сваляне</a> за да изберете най-близкото огледало.
</TRN>
<TRN locale="bg_BG" key="website.Official_releases">
Официални издания
</TRN>
<TRN locale="bg_BG" key="website.Old_releases">
Стари издания
</TRN>
<TRN locale="bg_BG" key="website.OS2_rel_inf">
Информация свързана с OS/2
</TRN>
<TRN locale="bg_BG" key="website.adv_namespace">
<STRONG>Всеки юнит има собствен идентификатор</STRONG> В Паскал няма притеснение от замърсяване на именното пространство, както е в Си, където идентификатор трябва да е уникален в цялата програма. Не, в Паскал всеки юнит получава собствено именно пространство и това е много облекчаващо.
</TRN>
<TRN locale="bg_BG" key="website.adv_No_Makefiles">
<STRONG>Без Makefile-ове</STRONG> За разлика от повечето програмни езици, Паскал не се нуждае от Makefile-ове. Можете да спестите много време, компилатора сам разбира кои файлове трябва да се прекомпилират.
</TRN>
<TRN locale="bg_BG" key="website.Back_to_general_download_page">
Обратно към общата страницата за изтегляне
</TRN>
<TRN locale="bg_BG" key="website.Back_to_mirrorlist">
Обратно към списъка с огледала
</TRN>
<TRN locale="bg_BG" key="website.BeOS_related_information">
Информация свързана с BeOS
</TRN>
<TRN locale="bg_BG" key="website.Binaries">
Бинарни файлове
</TRN>
<TRN locale="bg_BG" key="website.Binary_packages">
Бинарни пакети
</TRN>
...
<TRN locale="bg_BG" key="website.Contributed_Units">
Предоставени юнити
</TRN>
<TRN locale="bg_BG" key="website.cross_compiler_i386-linux_arm-linux">
Това е пакет за кръстосана компилация от i386-linux към arm-linux. Преди да го използвате трябва да инсталирате <a href="../i386/linux-@mirrorsuffix@@x@">СПК за i386-linux</a>.
</TRN>
...
<TRN locale="bg_BG" key="website.DEB_packages">
Debian пакети
</TRN>
<TRN locale="bg_BG" key="website.DEB_packages_1">
Debian пакети (.deb)
</TRN>
<TRN locale="bg_BG" key="website.Documentation_av_several_formats">
Документацията е налична в няколко формата (ако желаете да използвате документите извън текстовата ИСР, се нуждаете от HTML вариантите):
</TRN>
<TRN locale="bg_BG" key="website.DOS_rel_inf">
Информация срързана с DOS
</TRN>
<TRN locale="bg_BG" key="website.down_i386_freebsd_note">
FreeBSD 4.x и вероятно също 5.x
</TRN>
<TRN locale="bg_BG" key="website.down_i386_netware_note">
само 2.0.0
</TRN>
<TRN locale="bg_BG" key="website.Download_as_installer">
Изтегли като инсталатор
</TRN>
<TRN locale="bg_BG" key="website.download_documentation">
Документацията може да бъде изтеглена в различни формати от някой от нашите <a href="down/docs/docs@x@">портали за изтегляне</a>.
</TRN>
<TRN locale="bg_BG" key="website.download_in_1_file">
Изтегли като един голям файл
</TRN>
<TRN locale="bg_BG" key="website.faq_intro">
<p>Този документ съдържа информация от последната минута относно компилатора. Освен това, отговаря на често задаваните въпроси и предоставя решения на чести проблеми срещани с Free Pascal. Информацията предоставена тук винаги е по-актуална от тази в документацията на Free Pascal. </p>
</TRN>
<TRN locale="bg_BG" key="website.for_comprehensive">
<p> За по-изчерпателна информация за езика Паскал, и извиквания към runtime библиотеката, обърнете се към наръчниците на Free Pascal. Теми покрити в този документ: </p>
</TRN>
...
<TRN locale="bg_BG" key="website.Pascal_lang_rel_inf">
Информация свързана с езика Паскал
</TRN>
<TRN locale="bg_BG" key="website.plain_text">
чист текст
</TRN>
<TRN locale="bg_BG" key="website.ready_made_packages">
Това са готови пакети, заедно с инсталационна програма, за лесно инсталиране. Всички пакети съдържат README файл, който трябва да прочетете за инструкции по инсталирането и последни новини
</TRN>
<TRN locale="bg_BG" key="website.RPM_compatibility">
RPM пакетите са съвместими с всички RPM базирани дистрибуции, включително Red Hat, Fedora, SuSE, Mandriva.
</TRN>
<TRN locale="bg_BG" key="website.RPM_packages">
RPM (Redhat Package Manager) пакети
</TRN>
<TRN locale="bg_BG" key="website.RPM_packages_1">
RedHat пакети (.rpm)
</TRN>
<TRN locale="bg_BG" key="website.RTL_rel_inf">
Информация свързана с runtime библиотеката
</TRN>
<TRN locale="bg_BG" key="website.snapshots">
Снимки
</TRN>
<TRN locale="bg_BG" key="website.Source">
Сорс-код
</TRN>
<TRN locale="bg_BG" key="website.Source_packages">
Сорс-код пакети
</TRN>
...
<TRN locale="bg_BG" key="website.Units">
Юнити
</TRN>
<TRN locale="bg_BG" key="website.UNIX_rel_inf">
Информация свързана с UNIX
</TRN>
<TRN locale="bg_BG" key="website.Windows_rel_inf">
Информация свързана с Windows
</TRN>
<TRN locale="bg_BG" key="website.You_can_download_installer">
Можете да изтеглите инсталатора
</TRN>
<TRN locale="bg_BG" key="website.news_headline_20060828">
<em>28 август 2006</em>Дългоочакваното 2.0.4 издание е най-накрая факт (отидете <a href="download.html">тук</a> за да изберете най-близкото огледало), донасяйки много поправки и някои подобрения (запомнете, тове е предимно издание с оправени грешки за серия 2.0.x, докато новите неща се развиват в 2.1.x разклонение) спрямо предишната издадена версия 2.0.2 (а също 2.0.0, защото е налична за повече платформи от 2.0.2). Списък с промените може да намерите <a href="http://svn.freepascal.org/svn/fpcbuild/tags/release_2_0_4/install/doc/whatsnew.txt">тук</a>.
</TRN>
<TRN locale="en_US" key="website.Select_download_site">
Please select the site from which you want to download:
</TRN>
<TRN locale="nl_NL" key="website.Select_download_site">
Kies de locatie waarvandaan u wilt downloaden:
</TRN>
...
<TRN locale="nl_NL" key="website.UNIX_rel_inf">
Informatie betreffende UNIX
</TRN>
<TRN locale="nl_NL" key="website.PalmOS_rel_inf">
Informatie betreffende PalmOS
</TRN>
<TRN locale="nl_NL" key="website.RTL_rel_inf">
Informatie betreffende de runtime-bibliotheek
</TRN>
<TRN locale="nl_NL" key="website.Amiga_tel_inf">
Informatie betreffende de Amiga
</TRN>
<TRN locale="nl_NL" key="website.DOS_rel_inf">
Informatie betreffende DOS
</TRN>
<TRN locale="nl_NL" key="website.BeOS_related_information">
Informatie betreffende BeOS
</TRN>
<TRN locale="nl_NL" key="website.OS2_rel_inf">
Informatie betreffende OS/2
</TRN>
...
<TRN locale="nl_NL" key="website.already_included_zip">
is reeds aanwezig in het grote zip-bestand hierboven
</TRN>
