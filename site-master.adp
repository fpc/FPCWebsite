...
<div id="content">
 <div id="sidebar">
  <h1>General</h1>
  <div class="submenu">
   <a href="@maindir@"><trn locale="en_US" key="website.Home">Home</a>
   <a href="@maindir@news@x@"><trn locale="en_US" key="website.News">News</a>
   <a href="@maindir@download@x@"><trn locale="en_US" key="website.Download">Download</a> 
