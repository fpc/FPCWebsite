...
#ENTRY advantage
#SUBENTRY
#HEADER Advantages of Free Pascal
-->
<HTML>
<H2>Advantages of programming in Pascal and Free Pascal</H2>
...
<P>
<UL>
    <LI><STRONG>Very clean language</STRONG> Pascal is a very nice language,
    ...
    <LI><STRONG>No Makefiles</STRONG> Unlike most programming languages,
    ...
    <LI><STRONG>Pascal compilers are Fast with a big F and Free Pascal
    ...
    for large programs.
    <LI><STRONG>Each unit has it's own identifiers</STRONG> In Pascal you
    ...
    <LI><STRONG>Integrated development environment</STRONG> Free Pascal comes
    ...
    <LI><STRONG>Great integration with assembler</STRONG> Do you think pascal is
    ...
    <LI><STRONG>Object oriented programming</STRONG> And if you do the serious
    ...
    <LI><STRONG>Smartlinking</STRONG> Free Pascal's smart linker leaves out any
    ...
    <LI><STRONG>Distribution independence (Linux)</STRONG> As a result of this,
    ...
    <LI><STRONG>Available for a lot of platforms on several architectures</STRONG>
    Free Pascal is
    ...
    <LI><STRONG>Compatible</STRONG> Have existing code? Free Pascal is more
