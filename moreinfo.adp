...
<ul>
  ...
  <a href="http://www.cul.de/freepascal@x@">C&amp;L</a>.</trn></li>
  ...
  <li><trn key="website.moreinfo.mailing" locale="en_US">join one of the <a href="maillist@x@">mailing lists</a>.</trn></li>
  ...
  <li><trn key="website.moreinfo.manuals" locale="en_US">Our manuals are written for people who already know how to program in Pascal. <br>
  If you are looking for information how you can learn Pascal,<br>
  Tao Yue's <a href="http://wiki.lazarus.freepascal.org/Object_Pascal_Tutorial">Learn Pascal Tutor</a>  is a good choice.</trn></li>
  <li>
