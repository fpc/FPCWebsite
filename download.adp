...
<p>
  <trn key="website.latest_release" locale="en_US">The latest release is</trn> <b>2.4.2</b>.
<p>
<trn key="website.available_limited_platforms" locale="en_US">
  Because of a lack of release builders and testers, 2.4.2 is only available for a limited
