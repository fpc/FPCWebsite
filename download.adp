...
<p>
  <trn key="website.latest_release" locale="en_US">The latest release is</trn> <b>3.0.0</b>.
<p>
<trn key="website.available_limited_platforms" locale="en_US">
  Because of a lack of release builders and testers, 3.0.0 is only available for a limited
...
<p>
  <trn key="website.can_download_for_platform" locale="en_US">
    You can download the 3.0.0 release for the following cpu and operating systems:
  </trn>
<p>
<ul>
    <li>ARM
