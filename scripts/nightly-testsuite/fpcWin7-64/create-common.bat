...
rem Default FPC_RELEASE_VERSION env variable, first try STARTVERSION env
if "x%FPC_RELEASE_VERSION%" == "x" set FPC_RELEASE_VERSION=%STARTVERSION%
if "x%FPC_RELEASE_VERSION%" == "x" set FPC_RELEASE_VERSION=3.2.0
