...
<A href='http://www.osnews.com/story.php?news%5fid=10607'>an article</A> written by Free Pascal
   ...
   <UL>
     <LI>
      ...
      running <a href="http://www.morphos.net">MorphOS</a>.
     </li>
   </ul>
   <LI>31 May 2004</LI>
   <UL>
   ...
   <LI>5 November 2003</LI> <UL><LI> A first public beta, taken from the
   ...
   <LI>21 October 2003</li>
   <ul><li> The work on the first 2.0 beta is progressing nicely and a first release is scheduled for 1st
    ...
    <p>
    To avoid confusion: this will be the first release of the 1.1 development branch
   ...
   <LI>24 January 2003</LI>
   <UL>
     <LI>
         The mailing lists are now working again.
     </LI>
   </UL>
   <LI>22 January 2003</LI>
   <UL>
     <LI>
   ...
   <LI>15 november 2001</LI>
   <UL>
     <LI> New FAQ which is more comprehensive. </LI>
   </UL>

   <LI>19 september 2001</LI>
   <UL>
