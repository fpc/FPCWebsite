   ...
   <OL>
		...
		<li>Repackagings that affect sources are indicated with a single letter as 
		 ...
		 after the release of 2.4.2 the fixes_2_4 branch identified itself as version 2.4.3 till 2.4.4 branched off (typically
 		 two months before its release).  After 2.4.4, the stable branch's number was updated to 2.4.5,
        ...
        <li><a name='FPandGNUPascal'></a>
          ...
          <trn key="website.a_FPC_vs_GPC" locale="en_US">
            ...
            <DT><b>Version:</b>
            <DD>Currently, Free Pascal is at version 2.6.4 (March 2014). GNU Pascal is stopped
