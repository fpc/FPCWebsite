   ...
   <OL>
        ...
        <li><a name='versions'></a>
          ...
          <trn key="website.a_What_versions_exist" locale="en_US">
            <p>The latest official version is 2.4.0, the first release of the 2.4.x series
        ...
        <li><a name='FPandGNUPascal'></a>
          ...
          <trn key="website.a_FPC_vs_GPC" locale="en_US">
            ...
            <DT><b>Version:</b>
            <DD>Currently, Free Pascal is at version 2.4.0 (December 2010). GNU Pascal is at
