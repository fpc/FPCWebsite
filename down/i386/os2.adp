<master>
<property name="title"><trn key="website.down.i386.os2.title" locale="en_US">Free Pascal - Download OS/2 version</trn></property>
<property name="entry">download</property>
<property name="header"><trn key="website.down.i386.os2.header" locale="en_US">Download OS/2</trn></property>
...
<ul>
<li><a href="@mirror_url@dist/@latestversion@/i386-os2/os2@shortversion@full.zip">os2@shortversion@full.zip</a> (116 MB) - <trn key="website.down.i386.os2.fullpackage" locale="en_US">full package (recommended)</trn></li>
<li><a href="@mirror_url@dist/@latestversion@/i386-os2/os2@shortversion@.zip">os2@shortversion@.zip</a> (43 MB) - <trn key="website.down.i386.os2.binaries" locale="en_US">binaries without sources and documentation</trn></li>
</ul>
...
<a href="@mirror_url@dist/@latestversion@/source/short/src@shortversion@.zip">src@shortversion@.zip</a> (41 MB) <trn key="website.down.i386.os2.or" locale="en_US">or</trn></li>
...
<ul>
<li><a href="@mirror_url@dist/@latestversion@/docs/doc-pdf.zip">PDF</a></li>
<li><a href="@mirror_url@dist/@latestversion@/docs/doc-html.zip">HTML</a> (<trn key="website.to_be_used_from_IDE" locale="en_US">the basic option for the IDE</trn>)</li>
<li><a href="@mirror_url@dist/@latestversion@/docs/doc-ps.zip">PostScript</a> (<trn key="website.down.i386.os2.printing" locale="en_US">for printing</trn>)</li>
<li><a href="@mirror_url@dist/@latestversion@/docs/doc-chm.zip">CHM</a> (<trn key="website.already_included_zip" locale="en_US">compressed HTML - supported in the text mode IDE</trn>)</li>
<li><a href="@mirror_url@dist/@latestversion@/docs/doc-txt.zip"><trn key="website.plain_text" locale="en_US">plain text</trn></a></li>
</ul>
