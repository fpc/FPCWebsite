...
<p><trn key="website.native_compiler_not_available_msdos">There is no native compiler available for i8086 MS-DOS. You have to use a cross-compiler.</trn></p>

<h3><trn key="website.Download_cross_compilers_from_other_host_m" locale="en_US">Download cross-compilers running on another host</trn></h3>
<p><trn key="website.other_host_cross_installer_prerequisite_m">These cross-compilers run on another host and need the corresponding native compiler as a prerequisite.</trn></p>
<ul>
  <li>
    ...
    <p><trn key="website.i8086-msdos_file_download_descr" locale="en_US">Contains the installer with the win32 to MS-DOS (real mode, i8086) cross-compiler. It needs the <a href="@mirror_url@dist/@latestversion@/i386-win32/fpc-@latestversion@.i386-win32.exe">native Win32 compiler</a> (39 MB) to be able to work.</trn></p>
  <li>
  ...
  <li>
    <a href="@mirror_url@dist/@latestversion@/i8086-msdos/fpc-@latestversion@.x86_64-linux.cross.i8086-msdos.tar.xz">fpc-@latestversion@.x86_64-linux.cross.i8086-msdos.tar.xz</a> 
  ...
  <li>
    <a href="@mirror_url@dist/@latestversion@/i8086-msdos/fpc-i8086-msdos-@latestversion@-1.i686.rpm">fpc-i8086-msdos-@latestversion@-1.i686.rpm</a>  
  ...
  <li>
    <a href="@mirror_url@dist/@latestversion@/i8086-msdos/fpc-i8086-msdos-@latestversion@-1.i686.src.rpm">fpc-i8086-msdos-@latestversion@-1.i686.src.rpm</a>  
    <p><trn key="website.Download_linux_i386_msdos_cross_srpm" locale="en_US">The associated i386 to i8086 SRPM
  <li>
    <a href="@mirror_url@dist/@latestversion@/i8086-msdos/fpc-i8086-msdos-@latestversion@-1.x86_64.rpm">fpc-i8086-msdos-@latestversion@-1.x86_64.rpm</a>   
  ...
  <li>
    <a href="@mirror_url@dist/@latestversion@/i8086-msdos/fpc-i8086-msdos-@latestversion@-1.x86_64.src.rpm">fpc-i8086-msdos-@latestversion@-1.x86_64.src.rpm</a> 
    <p><trn key="website.Download_linux_x86_64_msdos_cross_srpm" locale="en_US">The associated x86_64 to i8086 SRPM
</ul>

<hr>
<p>
<a href="gba@x@"><trn key="website.Back_to_mirrorlist" locale="en_US">Back to mirror list</trn></a><br>
