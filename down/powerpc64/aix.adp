<master>
<property name="title"><trn key="website.down.powerpc64.aix.title" locale="en_US">Free Pascal - Download AIX</trn></property>
<property name="entry">download</property>
<property name="header"><trn key="website.down.powerpc64.aix.header" locale="en_US">Download AIX PowerPC64</trn></property>
...
<ul>
  <li> <a href="#aixbig"><trn key="website.everything_in_1" locale="en_US">Everything in 1 big package</trn></a>
</ul>
...
<hr>
<p>
<a href="aix@x@"><trn key="website.Back_to_mirrorlist" locale="en_US">Back to mirror list</trn></a><br/>
