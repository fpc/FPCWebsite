...
<trn key="website.latest_version_is" locale="en_US">
  The latest cross compiler release version is <b>2.2.4</b>.
</trn>

<h1>2.2.4</h1>
The FPC 2.2.4 package for x86_64-win64 is available in one easy to choose format:
<ul>
...
<ul>
<li><trn key="website.Download_win32_win64_1_file_download_descr" locale="en_US"><a href="@mirror_url@dist/2.2.4/i386-win32/fpc-2.2.4.x86_64-win64.exe">fpc-2.2.4.x86_64-win64.exe</a> (17 MB)</li>
</ul>
