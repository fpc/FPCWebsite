...
<p><trn key="website.native_compiler_nat_available_x86_64">There is no native compiler available for x86_64 Win64. You have to use a cross-compiler.</trn></p>
...
<p><trn key="website.Download_win32_win64_cross_installer" locale="en_US">Contains the installer with the win32 to x86_64-Win64 cross-compiler. It needs the <a href="@mirror_url@dist/@latestversion@/i386-win32/fpc-@latestversion@.i386-win32.exe">native Win32 compiler</a> (51 MB) to be able to work.</trn></p>
</ul>
