...
<ul>
<li><a href="@mirror_url@dist/3.0.0/x86_64-linux/fpc-3.0.0.x86_64-linux.tar">fpc-3.0.0.x86_64-linux.tar</a> (47 MB)
...
<li> <a href="@mirror_url@dist/3.0.0/x86_64-linux/rpm/fpc-3.0.0-1.x86_64.rpm">fpc-3.0.0-1.x86_64.rpm</a> (27 MB)
     <trn key="website.x86_64-linux_rpm_download_descr" locale="en_US">
       contains the compiler, utils, RTL and all units. <br>
     </trn>
<li> <a href="@mirror_url@dist/3.0.0/x86_64-linux/rpm/fpc-debuginfo-3.0.0-1.x86_64.rpm">fpc-debuginfo-3.0.0-1.x86_64.rpm</a> (27 MB)
     <trn key="website.x86_64-linux_rpm_download_descr" locale="en_US">
       debuginfo<br>
     </trn>

<li> <a href="@mirror_url@dist/3.0.0/x86_64-linux/rpm/fpc-docs-3.0.0-1.x86_64.rpm">fpc-docs-3.0.0-1.x86_64.rpm</a> (6.7 MB)
...
<li> <a href="@mirror_url@dist/3.0.0/x86_64-linux/rpm/fpc-3.0.0-1.src.rpm">fpc-3.0.0-1.src.rpm</a> (25 MB)
...
<li><b>Deb archives for 3.0.0 are not available at the moment (the latest version available in Deb archives is 2.6.2).</b><br>
  <trn key="website.i386-linux_deb_download_descr_x86_64" locale="en_US"><a href="@mirror_url@dist/2.4.2/x86_64-linux/deb/">This directory</a> contains
