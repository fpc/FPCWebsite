...
<ul>
<li><a href="@mirror_url@dist/2.6.02/x86_64-linux/fpc-2.6.2.x86_64-linux.tar">fpc-2.6.2.x86_64-linux.tar</a> (47 MB)
...
<li> <a href="@mirror_url@dist/2.6.0/x86_64-linux/rpm/fpc-2.6.0-1.x86_64.rpm">fpc-2.6.0-1.x86_64.rpm</a> (27 MB)
     <trn key="website.i386-linux_rpm_download_descr" locale="en_US">
       contains the compiler, utils, RTL and all units. <br>
     </trn>
<li> <a href="@mirror_url@dist/2.6.0/x86_64-linux/rpm/fpc-docs-2.6.0-1.x86_64.rpm">fpc-docs-2.6.0-1.x86_64.rpm</a> (6.7 MB)
...
<li> <a href="@mirror_url@dist/2.6.0/x86_64-linux/rpm/fpc-2.6.0-1.src.rpm">fpc-2.6.0-1.src.rpm</a> (25 MB)
