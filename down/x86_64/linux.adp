...
<ul>
<li><a href="@mirror_url@dist/2.4.4/x86_64-linux/fpc-2.4.4.x86_64-linux.tar">fpc-2.4.4.x86_64-linux.tar</a> (36 MB)
...
<li> <a href="@mirror_url@dist/2.4.4/x86_64-linux/rpm/fpc-2.4.4-1.x86_64.rpm">fpc-2.4.4-1.x86_64.rpm</a> (27 MB)
     <trn key="website.i386-linux_rpm_download_descr" locale="en_US">
       contains the compiler, utils, RTL and all units. <br>
     </trn>
<li> <a href="@mirror_url@dist/2.4.4/x86_64-linux/rpm/fpc-docs-2.4.4-1.x86_64.rpm">fpc-docs-2.4.4-1.x86_64.rpm</a> (6.7 MB)
...
<li> <a href="@mirror_url@dist/2.4.4/x86_64-linux/rpm/fpc-2.4.4-1.src.rpm">fpc-2.4.4-1.src.rpm</a> (25 MB)
