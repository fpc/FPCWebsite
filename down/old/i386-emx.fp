<!--
#TITLE Free Pascal - download EMX version
#ENTRY EMX
#HEADGIF download
...
<ul>
<li> <A
HREF="$MIRRORURL/olddist/1.0.10/os2-1.0.10/os21010full.zip">os21010full.zip</a> (24.7 MB)
...
<ul>
<li> Install program: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/install.exe">install.exe</a> (286 kB)
<li> ...and its data file <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/install.dat">install.dat</a> (12 kB)
<li> ...as well as the unzip dll: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/unzip32.dll">unzip32.dll</a> (220 kB)
<li> DOS mode install program (only necessary for if installing under DOS): <A
HREF="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/installd.exe">installd.exe</a> (289 kB)
and its data file <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/installd.dat">installd.dat</a> (12 kB).
<li> Base files (program and units): <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/baseemx.zip">baseemx.zip</a> (1.2 Mb)
<li>Selected EMX utilities for Free Pascal:
<ul>
  <li> <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/asldemx.zip">asldemx.zip</a> (1.8 MB)</li>
  <li> <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/gdbemx.zip">gdbemx.zip</a> (654 kB)
</ul></li>
...
<ul>
<li> The readme file: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/readme.txt">readme.txt</a> (12 kB)
<li> The "what's new ?" file: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/whatsnew.txt">whatsnew.txt</a> (14 kB)
<li> FCL units: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/ufclemx.zip">ufclemx.zip</a> (737 kB)
<li> GTK units: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/ugtkemx.zip">ugtkemx.zip</a> (334 kB)
<li> fpGTK units: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/ufpgtkemx.zip">ufpgtkemx.zip</a> (226 kB)
<li> Paszlib units (needed by FCL): <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/upzlemx.zip">upzlemx.zip</a> (81 kB)
<li> Regular expression  units: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/uregemx.zip">uregemx.zip</a> (5 kB)
<li> Zip units: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/uzipemx.zip">uzipemx.zip</a> (28 kB)
<li> Utilities: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/utilemx.zip">utilemx.zip</a> (995 kB)
<li> Demo files: <a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/demo.zip">demo.zip</a> (131 kB)
<li> Documentation in PDF: <a href="$MIRRORURL/olddist/1.0.10/docs-1.0.10/docs-pdf.zip">docs-pdf.zip</a> (3.45 MB)
<li> Documentation in HTML (needed for IDE help): <a href="$MIRRORURL/olddist/1.0.10/docs-1.0.10/doc-htm.zip">doc-htm.zip</a> (6.7 Mb)
</ul>
...
<a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/makeemx.zip">makeemx.zip</a> (249Kb)
<li>EMX DLL (necessary for the OS/2 installer if EMX runtime not installed yet):
<a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/emx.dll">emx.dll</a> (91Kb)
<li>EMX wrapper DLL (necessary for the OS/2 installer if EMX runtime not installed yet):
<a href="$MIRRORURL/olddist/1.0.10/os2-1.0.10/separate/emxwrap.dll">emxwrap.dll</a> (16Kb)
</ul>
</OL>
<p>
...
<hr>
<p>
<a href="i386-emx.html">Back to mirror list</a><BR/>
<a href="down-$MIRRORSUFFIX.html">Back to all old releases</a>
