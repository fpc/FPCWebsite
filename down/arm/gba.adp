...
<p><trn key="website.native_compiler_not_available_gba">There is no native compiler available for the Game Bod Advance. You have to use a cross-compiler.</trn></p>
