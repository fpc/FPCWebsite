...
<trn key="website.latest_version_is" locale="en_US">
  The latest cross compiler release version is <b>2.2.2</b>.
</trn>

<h1>2.2.2</h1>
The FPC 2.2.2 package for arm-wince is available in one easy to choose format:
<ul>
  <li> <a href="#wince">Everything in 1 big package</a>
</ul>

<p>
<trn key="website.cross_compiler_i386-win32_arm-wince" locale="en_US">
...
<ul>
<li><trn key="website.arm-wince_1_file_download_descr" locale="en_US"><a href="@mirror_url@dist/i386-win32-2.2.2/fpc-2.2.2.arm-wince.exe">fpc-2.2.2.arm-wince.exe</a> (7 MB)
