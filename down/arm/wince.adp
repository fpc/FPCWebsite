...
<h1>2.6.0</h1>
The FPC 2.6.0 package for arm-wince is available in one easy to choose format:
<ul>
...
<ul>
<li><trn key="website.arm-wince_1_file_download_descr" locale="en_US"><a href="@mirror_url@dist/2.6.0/i386-win32/fpc-2.6.0.arm-wince.exe">fpc-2.6.0.arm-wince.exe</a> (11 MB)
