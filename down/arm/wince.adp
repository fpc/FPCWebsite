...
<trn key="website.latest_version_is" locale="en_US">
  The latest cross compiler release version is <b>2.2.0</b>.
</trn>

<h1>2.2.0</h1>
The FPC 2.2.0 package for arm-wince is available in one easy to choose format:
<ul>
...
<ul>
<li><trn key="website.arm-wince_1_file_download_descr" locale="en_US"><a href="@mirror_url@dist/i386-win32-2.2.0/fpc-2.2.0.arm-wince.exe">fpc-2.2.0.arm-wince.exe</a> (7 MB)
