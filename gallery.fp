...
#ENTRY moreinfo
#SUBENTRY gallery
#HEADER Gallery of programs written with Free Pascal
-->
...
<TABLE width=100% cellspacing=5>
  <TR>
    <TD width=50%>
      ...
      Wars can be played both on a single computer as well as over a network.
      </FONT>
    </TD>
    <TD width=50%>
  ...
  <TR>
    <TD width=50%>
      ...
      develope their telecom network management with Free Pascal. It is used
  ...
  <TR>
    <TD width=50%>
      ...
      wave functions and polarisations.
      </FONT
    </TD>
    <TD width=50%>
