...
<TRN locale="en_US" key="website.q_Huge_files">
Accessing huge files using standard I/O routines
</TRN>
<TRN locale="en_US" key="website.q_dos_release">
Releasing software generated by the DOS compiler
</TRN>
<TRN locale="en_US" key="website.a_Huge_files">
...
The Free Pascal web site is available in Bulgarian, Chinese, Dutch, English, Finnish, French, Polish,
...
<TRN locale="en_US" key="website.q_win_makefile">
Makefile problems on Win2000 (and NT)
</TRN>
...
<TRN locale="en_US" key="website.q_install106win32">
INSTALL.EXE of version 1.0.6 returns errors under some version of Windows
</TRN>
